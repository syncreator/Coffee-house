...
const img = document.querySelectorAll('.slide-trans .slide img')
const line = document.querySelector('.slide-trans')
...
line.addEventListener('mouseenter', stopInterval); <!--event handler-->
line.addEventListener('mouseleave', startInterval); <!--event handler-->

function slider() {
  width = document.querySelector('.slide-trans').offsetWidth
